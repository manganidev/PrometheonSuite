...
**Updated `tests\PrometheonSuite.FunctionalTests\PrometheonSuite.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\PrometheonSuite.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\PrometheonSuite.FunctionalTests\PrometheonSuite.FunctionalTests.csproj
```
