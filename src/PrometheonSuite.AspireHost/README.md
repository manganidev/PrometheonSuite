...
1. Set `PrometheonSuite.AspireHost` as the startup project
...
```bash
dotnet ef migrations add MigrationName -c AppDbContext -p ../PrometheonSuite.Infrastructure/PrometheonSuite.Infrastructure.csproj -s PrometheonSuite.Web.csproj -o Data/Migrations
```
